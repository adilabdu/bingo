...
Route::get('/cartela/{name?}', [CashierGameController::class, 'cartela'])->name('cartela');
Route::get('/cartela/play/{id}', [CashierGameController::class, 'playCartela'])->name('play.cartela');
