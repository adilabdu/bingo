    ...
    <AdminLayout>
        <div class="space-y-8">
            ...
            <div v-if="winner" class="bg-green-100 p-8 rounded-lg shadow-lg">
                ...
                <p><strong>Numbers:</strong> {{ JSON.parse(winner.cartela.numbers).join(', ') }}</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <table class="min-w-full bg-white shadow rounded-lg">
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left">Cartela Numbers</th>
                    ...
                    <tr v-for="player in game.players" :key="player.id" class="border-b">
                        ...
                        <td class="px-4 py-2">{{ JSON.parse(player.cartela.numbers).join(', ') }}</td>
