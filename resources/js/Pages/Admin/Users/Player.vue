        ...
        <div class="space-y-8">
            ...
            <div class="bg-gradient-to-r from-purple-500 to-indigo-500 text-white p-8 rounded-lg shadow-lg flex items-center justify-between">
                ...
                <div class="text-right">
                    <p class="text-2xl font-semibold text-green-200">Balance: ${{ player.balance || '0.00' }}</p>
                    <button class="bg-blue-500 text-white py-2 px-4 rounded-lg mt-2">Add Funds</button>
                </div>
            </div>
